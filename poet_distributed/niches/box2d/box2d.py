...
class Box2DNiche(Niche):
    def __init__(self, env_configs, task_config, seed, init='random', stochastic=False):
        ...
        self.model.make_env(seed=seed, env_config=DEFAULT_ENV, task_config=task_config)
        self.init = init
    ...
    def __setstate__(self, state):
        ...
        self.task_config = state["task_config"]
        self.model.make_env(seed=self.seed, env_config=DEFAULT_ENV, task_config=state["task_config"])
